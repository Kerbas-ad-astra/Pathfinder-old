...
{
    class WBIGreenhouse : WBIResourceConverter
    {
        const string kCropFailed = "Your crops have failed! You gain no resources.";
        const string kCropYieldHigh = "Great crop yield! You gained {0:f2} ";
        const string kCropYield = "Harvest time! You gained {0:f2} ";
        const string kCropYieldLow = "Crop yield is lower than expected. You gained {0:f2} ";
        const string kInsufficientResources = "Crop failure! Not enough resources to grow crops.";
        const string kGrowingCrops = "Growing";
        ...
        InfoView infoView;
        WBIModuleSwitcher moduleSwitcher = null;
